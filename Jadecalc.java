...
public class Jadecalc {
     public static void main(String[] args){
        ...
        System.out.println("Character Banner or Weapon Banner? (CB or LB)");
    ...
    public static void LightconeBanner(int CV, int PA, int Pity){
